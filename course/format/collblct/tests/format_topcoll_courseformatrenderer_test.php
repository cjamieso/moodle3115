...
class format_collblct_courseformatrenderer_test extends advanced_testcase {
    ...
    public function test_section_summary() {
        ...
        $thevalue = self::call_method($this->outputus, 'render_from_template', array('format_collblct/sectionsummary', $sectionsummarycontext));
    ...
    public function test_collblct_section() {
        ...
        $courserenderer = $PAGE->get_renderer('format_collblct', 'course');
    ...
    public function test_section_hidden() {
        ...
        $thevalue = self::call_method($this->outputus, 'render_from_template', array('format_collblct/sectionhidden', $sectionhiddencontext));
        $this->assertEquals($thevalue, $theclass);
    ...
    public function test_stealth_section() {
        ...
        $thevalue = self::call_method($this->outputus, 'render_from_template', array('format_collblct/stealthsection', $stealthsectioncontext));
        $this->assertEquals($thevalue, $theclass);
    }
    ...
    */
    ...
    public function test_print_multiple_section_page_horizontal() {
        ...
        $theoutput = file_get_contents($CFG->dirroot.'/course/format/collblct/tests/phpu_data/test_print_multiple_section_page_css.txt');
        ...
        $theoutput .= self::call_method($this->outputus, 'collblct_section', array($section1, $this->course, false, 0));
        $theoutput .= '</ul>';
    ...
    public function test_toggle_all() {
        ...
        $thevalue = self::call_method($this->outputus, 'render_from_template', array('format_collblct/toggleall', $toggleallcontext));
    ...
    public function test_display_instructions() {
        ...
        $thevalue = self::call_method($this->outputus, 'render_from_template', array('format_collblct/displayinstructions', $displayinstructionscontext));
