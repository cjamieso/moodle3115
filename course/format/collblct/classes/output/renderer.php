...
class renderer extends \format_section_renderer_base {
     ...
     * @return string HTML to output.
     */
    protected function collblct_section($section, $course, $onsectionpage, $sectionreturn = null, $displayoptions = array()) {
    ...
    public function print_single_section_page($course, $sections, $mods, $modnames, $modnamesused, $displaysection) {
        ...
        $singlesectioncontext = array(
            ...
            'thissection' => $this->collblct_section($thissection, $course, true, $displaysection, array('sr' => $displaysection))
        );

        $sectionzero = $modinfo->get_section_info(0);
        if ($sectionzero->summary or !empty($modinfo->sections[0]) or $this->page->user_is_editing()) {
            $singlesectioncontext['sectionzero'] = $this->collblct_section($sectionzero, $course, true, $displaysection, array('sr' => $displaysection));
        }
    ...
    public function print_multiple_section_page($course, $sections, $mods, $modnames, $modnamesused) {
        ...
        if ($thissection->summary or ! empty($modinfo->sections[0]) or $this->userisediting) {
            echo $this->collblct_section($thissection, $course, false, 0);
        }
        ...
        if ($coursenumsections > 0) {
            ...
            foreach ($sectiondisplayarray as $thissection) {
                ...
                if (!empty($thissection->ishidden)) {
                    ...
                    $sectionoutput .= $this->collblct_section($thissection, $course, false, 0);
