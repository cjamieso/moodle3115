...
class format_collblct_course_renderer extends \core_course_renderer {
    ...
    public function course_section_cm($course, &$completioninfo, cm_info $mod, $sectionreturn, $displayoptions = array()) {
        ...
        return $this->output->render_from_template('format_collblct/sectioncm', $sectioncmcontext);
    }
    ...
    protected function course_section_cm_get_meta(cm_info $mod) {
        ...
        if ($meta->isteacher) {
            ...
            if (!empty($engagementmeta)) {
                ...
                $content = $this->output->render_from_template('format_collblct/sectioncmmeta', $sectioncmmetacontext);
            }
        } else {
            // Feedback meta.
            if (!empty($meta->grade)) {
